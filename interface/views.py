...
class UserCreateView(CreateView):
    ...
    def form_valid(self, form, *args, **kwargs):
        ...
        user.invite_code = create_unique_invite_code()  # Генерирует и присваивает инвайт-код
...
class SmsCodeView(View):
    ...
    def get(self, *args, **kwargs):
        ...
        return render(self.request, 'interface/sms_code.html', {'form': form})  # Отображает форму
